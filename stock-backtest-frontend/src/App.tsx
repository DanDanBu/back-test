...
export default function App() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setFundError("找不到股票資料，請確認代碼是否正確 (e.g. AAPL、TSLA、2330.TW)");
    } finally {
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: "0.65rem", color: "#475569", letterSpacing: "0.06em" }}>
              STOCK FUNDAMENTALS SYSTEM
            </div>
          </div>
        </div>
      ...
      <main style={{ maxWidth: 1280, margin: "0 auto", padding: "32px 24px" }}>
        ...
        {!fundamentals ? (
          ...
          >
            ...
            {fundError && (
              <div style={{ marginTop: 12, fontSize: "0.82rem", color: "#ff4040" }}>{fundError}</div>
            )}
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 20, flexWrap: "wrap", justifyContent: "center" }}>
              {["AAPL", "TSLA", "NVDA", "MSFT", "GOOGL"].map(t => (
                <button
                  ...
                  onMouseEnter={e => { (e.target as HTMLButtonElement).style.color = "#00d4ff"; (e.target as HTMLButtonElement).style.borderColor = "rgba(0,212,255,0.4)"; }}
                  onMouseLeave={e => { (e.target as HTMLButtonElement).style.color = "#64748b"; (e.target as HTMLButtonElement).style.borderColor = "rgba(0,212,255,0.15)"; }}
                >
                  {t}
                </button>
              ))}
              ...
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
                    <span className="neon-cyan mono" style={{ fontSize: "2rem", fontWeight: 800 }}>
                      {fundamentals.symbol}
                    </span>
                    <span
                      style={{
                  ...
                  <div style={{ fontSize: "1.1rem", color: "#cbd5e1", marginBottom: 4 }}>
              ...
              <div className="glass-card" style={{ padding: "24px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 18 }}>
                  {[
                    ...
                    <div key={label}>
                      <label style={{ display: "block", fontSize: "0.7rem", color: "#64748b", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 }}>
                        {label}
                      </label>
                      <input
                        type="number"
                ...
                <button
                  ...
                  style={{ width: "100%", marginBottom: 20, justifyContent: "center", display: "flex", alignItems: "center" }}
                >
                  {loadingBack ? (
                    <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <span className="spinner" /> 回測運算中...
                    </span>
                  ) : "執行回測"}
                </button>
                ...
                {backtestResult ? (
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    >
                      <div>
                        <div style={{ fontSize: "0.68rem", color: "#64748b", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 4 }}>
                          策略累積報酬
                        </div>
                        <div style={{ fontSize: "0.8rem", color: "#334155" }}>
                          SMA&nbsp;{backtestResult.short_window}&nbsp;/&nbsp;{backtestResult.long_window}
                        </div>
                      </div>
                      <div
                        className="mono"
                        style={{
                          ...
                          color: returnColor,
                          textShadow: `0 0 24px ${returnColor}55`,
                        }}
                      >
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={chartData} margin={{ top: 4, right: 4, bottom: 0, left: -8 }}>
                          ...
                          <XAxis
                            ...
                            label={{ value: "Day", position: "insideBottomRight", offset: -4, fill: "#334155", fontSize: 10 }}
                          />
                          <YAxis
                            stroke="#1e293b"
                            tick={{ fill: "#334155", fontSize: 10 }}
                          ...
                          <Line
                            ...
                            dot={false}
                            strokeWidth={2}
                            activeDot={{ r: 4, fill: returnColor }}
                          />
                        </LineChart>
                      </ResponsiveContainer>
                    </div>
                ...
                <div
                  style={{
                    marginTop: 16, fontSize: "0.68rem", color: "#1e293b", lineHeight: 1.7,
